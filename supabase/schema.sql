create table if not exists public.score_submissions (
  ...
  game_key text not null check (game_key in ('tetris','snake','pong','breakout','memory','merge','dodge','connect','whack','reaction','tic','simon','rps','math','maze','platformer','rem_runner')),
